(function($) {
    ...
    if (document.getElementById("active_now") !== null) {
        const active_now = document
            .getElementById("active_now")
            .getContext("2d");
    ...
    //stalked bar chart
    if (document.getElementById("user_acq") !== null) {
    ...
    //doughut chart
    if (document.getElementById("session_device") !== null) {
        const session_device = document
            .getElementById("session_device")
            .getContext("2d");
    ...
    //Sales chart
    if (document.getElementById("trending_over_time") !== null) {
