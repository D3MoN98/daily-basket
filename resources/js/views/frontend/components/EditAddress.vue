<template>
  ...
  >
    <a href="javascript:void(0)" class="closebtn" @click.prevent="closeEditAddress">&times;</a>
    <div class="address_bar">
      <h4>Edit Address {{id}}</h4>
      <div class="map">
...
export default {
  ...
  methods: {
    ...
    updateAddress () {
      ...
      this.$store
        .dispatch('user/updateAddress', { id: this.id, address: this.address })
        .then(() => {
          this.submitted = false;
          this.formError = false;
