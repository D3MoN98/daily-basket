...
export default {
    ...
    methods: {
        payAndOrder() {
            ...
            const numberValidation = CardValidator.number(
                myCard.CardJs("cardNumber")
            );
            const cvvValidation = CardValidator.cvv(myCard.CardJs("cvc"));
            const expiryMonthValidation = CardValidator.expirationMonth(
                myCard.CardJs("expiryMonth")
            );
            const expiryYearValidation = CardValidator.expirationYear(
                myCard.CardJs("expiryYear")
            );
            ...
            if (
                ...
                !expiryMonthValidation.isValid ||
                !expiryYearValidation.isValid ||
                !nameValidation
            ) {
                this.isInValid = true;
