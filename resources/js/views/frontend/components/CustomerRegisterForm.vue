<template>
    ...
    >
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.name.$error
            }"
        >
            <input
                type="text"
            ...
            >
            <span
                v-if="formError && !$v.customer.name.required"
        ...
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.email.$error
            }"
        >
            <input
                type="email"
        ...
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.password.$error
            }"
        >
            <input
                type="password"
                ...
                :class="{
                    'is-invalid': formError && $v.customer.password.$error
                }"
        ...
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.confirm_password.$error
            }"
        >
            <input
                type="password"
        ...
        <div class="row">
            <div class="col-sm-6">
                <div
                    ...
                    :class="{
                        'animate__animated animate__shakeX':
                            formError && $v.customer.contact_no.$error
                    }"
                >
                    <input
                        type="tel"
                    ...
                    <span
                        v-if="
                            formError && !$v.customer.contact_no.isUniqueContact
                        "
                        class="invalid-feedback"
        ...
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.house_no.$error
            }"
        >
            <input
                type="text"
                ...
                class="form-control"
                :class="{
                    'is-invalid': formError && $v.customer.house_no.$error
                }"
        ...
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.address.$error
            }"
        >
            <textarea
                ...
                class="form-control"
                :class="{
                    'is-invalid': formError && $v.customer.address.$error
                }"
        ...
        <div
            ...
            :class="{
                'animate__animated animate__shakeX':
                    formError && $v.customer.address_type.$error
            }"
        >
            <div class="chk_btnn">
                <input
