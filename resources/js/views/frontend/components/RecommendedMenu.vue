<template>
    <div
        id="recommendedMenu"
        class="food_tab_items animate__animated animate__fadeIn"
    >
        <!-- <h3>Lunch1</h3>
    <h4>Indian</h4>-->
        <div class="food_ottr">
            <ul>
                <MenuItem
                    v-show="isRecommendedMenuItemLoaded"
                    v-for="menu_item in recommended_menu_items"
                    :key="menu_item.id"
                    :menu_item="menu_item"
                />
                <li
                    v-if="recommended_menu_items.length === 0"
                    v-show="isRecommendedMenuItemLoaded"
                >
