          ...
          <div class="crnt_status_bar">
            <ul>
              <li
                :class="{
                  active_part:
                    _.indexOf(['accepted', 'processing'], order.status) !== -1,
                }"
              >
                <span> <i class="fas fa-check-circle"></i> </span>Accepted
              </li>
              <li
                :class="{
                  active_part:
              ...
              >
                <span> <i class="fas fa-check-circle"></i> </span>In Progress
              </li>
              <li
                :class="{
                  active_part:
              ...
              >
                <span> <i class="fas fa-check-circle"></i> </span>Out for
                delivery
              </li>
              <li :class="{ active_part: order.status == 'delivered' }">
                <span> <i class="fas fa-check-circle"></i> </span>Delivered
              </li>
            </ul>
          </div>
        </li>
