...
const actions = {
    ...
    async cuisines({ commit }) {
        return axios
            .get(`/api/seller/cuisines`)
            .then(res => res.data)
            .then(res => {
    ...
    async updateRestaurant({ commit }, restaurant) {
        return axios
            .post(`/api/seller/restaurant`, restaurant)
            .then(res => res.data)
            .then(res => {
                commit("setRestaurantDetails", res.data);
            });
    },
    async updateRestaurantImage({ commit }, data) {
        return axios
            .post(`/api/seller/restaurant/image`, data)
            .then(res => res.data)
            .then(res => {
                commit("setRestaurantDetails", res.data);
            });
    },
    async menu_categories({ commit }) {
        return axios
            .get(`/api/seller/menu_categories`)
            .then(res => res.data)
            .then(res => {
                commit("setMenuCategories", res.data);
            });
    },
    async menu_sub_categories({ commit }) {
        return axios
            .get(`/api/seller/menu_sub_categories`)
            .then(res => res.data)
            .then(res => {
